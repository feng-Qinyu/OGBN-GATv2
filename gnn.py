...
class GAT(torch.nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels, num_layers, dropout, heads=1):
        super(GAT, self).__init__()
        self.gat1 = GATv2Conv(in_channels, hidden_channels, heads=1)
        self.gat2 = GATv2Conv(hidden_channels*heads, out_channels)
